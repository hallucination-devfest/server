package com.cheep.hallucination.exception;
...
public enum ErrorCode {
    ...
    NOT_FOUND_CHARACTER(40405, HttpStatus.NOT_FOUND , "존재하지 않는 캐릭터입니다."),
    ...
    BAD_REQUEST_MULTI(40007, HttpStatus.BAD_REQUEST, "멀티파트 오류"),

    // Access Denied Error
    ACCESS_DENIED(40300, HttpStatus.FORBIDDEN, "접근 권한이 없습니다."),
    NOT_MATCH_USER(40301, HttpStatus.FORBIDDEN, "해당 사용자가 일치하지 않습니다."),
    LAKE_OF_CHANCE(40302, HttpStatus.FORBIDDEN, "플레이 기회가 없습니다. 부스에 문의해주세요"),
    ...
    FILE_CONVERT_ERROR(42200, HttpStatus.UNPROCESSABLE_ENTITY, "파일을 변환할 수 없습니다."),
